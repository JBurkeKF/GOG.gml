...
g++ -m32 GOG.gml/x86/GOG.gml.o -shared -o GOG.gml.gmx/extensions/GOG.gml/x86/GOG.gml.dylib -Wl,-rpath,assets/ -LGOG/Libraries -lgalaxy
g++ -m64 -O3 -fPIC -g -c -o GOG.gml/x64/GOG.gml.o GOG.gml/GOG.gml.cpp -std=c++11
g++ -m64 GOG.gml/x64/GOG.gml.o -shared -o GOG.gml.gmx/extensions/GOG.gml/x64/GOG.gml.dylib -Wl,-rpath,assets/ -LGOG/Libraries -lgalaxy
